...
const listaParlamento =
      document.getElementById("listaParlamento");
...
function renderizarOpciones(){
    ...
    if(!listaParlamento) return;

    listaParlamento.innerHTML = "";
        ...
        inputs.forEach(input => {
            ...
            input.addEventListener("input", () => {
                ...
                if(numero > 99){
                    ...
                    hablar(
                        "El máximo permitido es noventa y nueve."
                    );
                }
...
function seleccionarTarjeta(
    ...
    parlamentoSeleccionado = partido;
...
function confirmarVoto(){
    ...
    hablar(
        "Voto registrado correctamente. Finalizando proceso electoral."
    );
...
document.addEventListener("keydown", e => {
    ...
    if(
        ...
        const tarjetas =
              listaParlamento.querySelectorAll(".opcion");
